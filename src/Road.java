...
public class Road implements Facade {
	 ...
	 * @post  The ID of this new road will be equal to the given id | new.getID() == id
	 ...
	 * @return True if the given speed limit is greater than 0 and
	 * 		   less than or equal to the max speed limit and greater or equal to the road speed
	 ...
	 * @return True if the given road speed is greater than 0 and
	 * 		   less than or equal to the roads speed limit and less or equal than the maximum speed
