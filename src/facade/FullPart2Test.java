...
class FullPart2Test {
	...
	private static Location leuven, antwerp, brussels, gent;

	private static Road someRoad, t1_leuven_antwerp, t2_leuven_brussels, t3_brussels_gent, 
		t4_brussels_antwerp, t5_leuven_gent, c1_circularRoad_antwerp, 
		c2_circularRoad_brussels;
	...
	void setUpBeforeEach() throws Exception {
		...
		someRoad = null;
		t1_leuven_antwerp = theFacade.createRoad("T1", leuven, antwerp, 1111, 15.5F, 10.66F);
		t2_leuven_brussels = theFacade.createRoad("T2", leuven, brussels, 1500, 16.66F, 12.22F);
		t3_brussels_gent = theFacade.createRoad("T3", brussels, gent, 45, 85.0F, 30.0F);
		t4_brussels_antwerp = theFacade.createRoad("T4", brussels, antwerp, 55, 90.0F, 50.0F);
		t5_leuven_gent = theFacade.createRoad("T5", leuven, gent, 1500, 16.66F, 12.22F);
		c1_circularRoad_antwerp = theFacade.createRoad("C1", antwerp, antwerp, 55, 90.0F, 50.0F);
		c2_circularRoad_brussels = theFacade.createRoad("C2", brussels, brussels, 40, 30.0F, 20.0F);
		emptyRoute_leuven = theFacade.createRoute(leuven);
		route_leuven_antwerp_brussels_gent =
				theFacade.createRoute(leuven, t1_leuven_antwerp, t4_brussels_antwerp, t3_brussels_gent);
	...
	void tearDownAfterEach() throws Exception {
		...
		theFacade.terminateRoad(t3_brussels_gent);
	...
	void createLocation_AllAddressCharacterTest() throws Exception {
		...
		assertEquals("ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 ,",theFacade.getLocationAddress(theLocation));
		actualScore += 5;
	}
	...
	void getLocationAdjoiningRoads_LeakTest() throws Exception {
		...
		localLeuvenRoads.add(t3_brussels_gent);
		...
		assertFalse(leuvenRoads.contains(t3_brussels_gent));
		actualScore += 15;
	}
	...
	void createRoad_LegalCase() throws Exception {
		maxScore += 30;
		someRoad = theFacade.createRoad("E4", leuven, antwerp, 1500, 16.66F, 12.22F);
	...
	void createRoad_LocationsWithAdjoiningRoads() throws Exception {
		...
		someRoad = theFacade.createRoad("X99", leuven, antwerp, 1500, 16.66F, 12.22F);
		assertTrue(theFacade.locationHasAsAdjoiningRoad(leuven, someRoad));
	...
	void createRoad_IllegalIdentification() throws Exception {
		maxScore += 5;
		try {
			theFacade.createRoad("6", leuven, antwerp, 250, 14.44F, 10.0F);
			fail("Expecting exception to be thrown");
		} catch (ModelException exc) {
			actualScore += 5;
		}
	...
	void createRoad_IllegalLength() throws Exception {
		maxScore += 5;
		someRoad = theFacade.createRoad("X2", leuven, antwerp, -10, 5.55F, 3.6F);
	...
	void createRoad_IllegalEndPoints() throws Exception {
		maxScore += 9;
		try {
			theFacade.createRoad("X1", null, antwerp, 300, 2.22F, 1.0F);
			fail("Expecting exception to be thrown");
		} catch (ModelException exc) {
			actualScore += 3;
		}
		try {
			...
			theFacade.createRoad("X2", locationOutOfBounds, antwerp, 600, 5.55F, 4.0F);
			fail("Expecting exception to be thrown");
		} catch (ModelException exc) {
			actualScore += 3;
		}
		try {
			...
			theFacade.createRoad("X3", locationOutOfBounds, antwerp, 600, 5.55F, 4.0F);
			fail("Expecting exception to be thrown");
		} catch (ModelException exc) {
			actualScore += 3;
		}
	...
	void createRoad_IllegalSpeedLimit() throws Exception {
		maxScore += 5;
		try {
			theFacade.createRoad("X1", leuven, antwerp, -10, -4.56F, 3.0F);
			fail("Expecting exception to be thrown");
		} catch (ModelException exc) {
			actualScore += 5;
		}
	...
	void createRoad_IllegalAverageSpeed() throws Exception {
		maxScore += 5;
		try {
			theFacade.createRoad("X1", leuven, antwerp, -10, 5.0F, -3.0F);
			fail("Expecting exception to be thrown");
		} catch (ModelException exc) {
			actualScore += 5;
		}
	...
	void createRoad_SpeedLimitBelowAverageSpeed() throws Exception {
		maxScore += 8;
		try {
			theFacade.createRoad("X1", leuven, antwerp, -10, 2.0F, 3.0F);
			fail("Expecting exception to be thrown");
		} catch (ModelException exc) {
			actualScore += 8;
		}
	...
	void createRoute_ProperSequenceOfRoads() throws Exception {
		maxScore += 12;
		Route theRoute = theFacade.createRoute(leuven, t1_leuven_antwerp, t4_brussels_antwerp, t3_brussels_gent, t5_leuven_gent);
		assertEquals(leuven, theFacade.getRouteStartLocation(theRoute));
		assertEquals(4, theFacade.getRouteSegments(theRoute).length);
		assertEquals(t1_leuven_antwerp, theFacade.getRouteSegments(theRoute)[0]);
		assertEquals(t3_brussels_gent, theFacade.getRouteSegments(theRoute)[2]);
		actualScore += 12;
	}
	...
	void createRoute_ImProperSequenceOfSegments() throws Exception {
		maxScore += 15;
		try {
			theFacade.createRoute(leuven, t1_leuven_antwerp, t4_brussels_antwerp, t3_brussels_gent, t2_leuven_brussels);
			fail("Expecting exception to be thrown");
		} catch (ModelException exc) {
			actualScore += 15;
		}
	...
	void createRoute_NullSequenceSegments() throws Exception {
		maxScore += 3;
		try {
			theFacade.createRoute(leuven, (Road[])null);
			fail("Expecting exception to be thrown");
		} catch (ModelException exc) {
			actualScore += 3;
		}
	...
	void createRoute_LeakTest() throws Exception {
		...
		Route theRoute = theFacade.createRoute(leuven, (Road[])roads);
		roads[1] = null;
	...
	void addSegment_LegalCase() throws Exception {
		...
		theFacade.addRouteSegment(emptyRoute_leuven, t3_brussels_gent);
		...
		assertEquals(t3_brussels_gent, theFacade.getRouteSegments(emptyRoute_leuven)[2]);
		actualScore += 6;
	}
	...
	void getTotalLength_SingleCase() throws Exception {
		...
		theFacade.changeRoadLength(t3_brussels_gent, 70);
